const appversion = "Level06_MultiStrategy_v3.3_MG_EarlyClose_MG"
  ...
  try {
    ...
    panel.innerHTML = `
      <div id="bot-candle-chart">
        ...
        <canvas id="bot-candle-canvas" width="300" height="240" style="width: 300px; height: 240px; background: #1e1e1e;"></canvas>
      </div>
    ...
    // Удален слушатель resize, чтобы избежать цикла
  } catch (e) {
...
function renderCandleChart(){
  ...
  }catch(e){ console.error('renderCandleChart error:', e); }
}
