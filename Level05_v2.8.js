...
// == Базовые настройки ==
const appversion = "Level05_CandleSuite_v2.8_MG_EarlyClose_MG";
...
const betArray1 = [
    ...
    {step: 3, value: 100, pressCount: 22 },
    {step: 4, value: 200, pressCount: 24 },
    {step: 5, value: 500, pressCount: 28 },
    {step: 6, value: 1000, pressCount: 34 },
];
const betArray2 = [
...
function updateUI(currentTime) {
    try {
        ...
        // Wager и Hit Rate (решение проблемы с расчетом)
