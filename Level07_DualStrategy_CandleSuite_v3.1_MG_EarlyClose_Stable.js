...
// == Базовые настройки ==
const appversion = "Level07_DualStrategy_CandleSuite_v3.1_MG_EarlyClose_Stable";
...
function __createLevel05UI() {
  try {
    ...
    if (!uiContainer) {
      ...
      uiContainer.style = 'position: fixed; top: 10px; right: 10px; background: rgba(0,0,0,0.7); color: #fff; padding: 10px; border-radius: 5px; z-index: 9999; font-size: 12px;';
